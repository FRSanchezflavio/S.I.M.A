...
export default function CargarMencionado() {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      setOk('Mencionado guardado correctamente');
      showToast('Mencionado guardado', 'success');
      ...
      let errorMessage = 'Error al registrar a la persona mencionada';
        ...
        <Card className="card">
          <CardContent>
            ...
            <Alert severity="info" sx={{ mb: 2, color: '#000' }}>
              ...
              fotografía para registrar a la persona mencionada.
            </Alert>
